# Train Attention Seeds baseline models
...
if __name__ == '__main__':
    # Script takes args: dimensionality, gpu
    dims = int(sys.argv[1])
    ...
    epochs = 25
    lr = 5e-2
    base_path = os.path.join('models', 'baseline_fixed', str(dims))
