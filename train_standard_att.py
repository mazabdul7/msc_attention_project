# Train Standard Luo Attention task-specific models
...
if __name__ == '__main__':
    # Script takes args: fol_name, gpu
    fol_name = sys.argv[1]
    ...
    epochs = 25
    lr = 5e-2
    base_path = os.path.join('models', 'task_models_standard', fol_name)
    ...
    for i in ['', '2', '3']: # Train 3 models to cross-validate performance later
        model_path = os.path.join(base_path, 'model_weights' + i)
        ...
        # Insert standard attention layer
